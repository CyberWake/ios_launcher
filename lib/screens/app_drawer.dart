        ...
        Expanded(
          child: GridView.builder(
            ...
            padding: EdgeInsets.symmetric(
              horizontal: 22.5,
              vertical: MediaQuery.of(context).size.height * 0.0375,
            ),
            itemBuilder: (context, index) {
              return Column(
                children: [
                  DrawerAppCategoryTile(
                      categoryApps: widget.allCategoryApps[index].categoryApps,
                      categoryName: widget.allCategoryApps[index].categoryName),
                  Hero(
